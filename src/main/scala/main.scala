...
class TwitterStreamCollectActor extends Actor {
  ...
  override def preStart(): Unit = {
    ...
    val update = dbSecond.update("816246658287534085", raw => {
...
//    restClient.actorRefFactory match { case system: ActorSystem => system.shutdown() }
//    streamingClient.actorRefFactory match { case system: ActorSystem => system.shutdown() }
  }
